...
| Secret | Source |
|---|---|
| `MONGODB_URI`, `LAKEHOUSE_MONGODB_URI`, `JWT_SECRET`, `MCP_ADMIN_KEY`, `CRON_SECRET`, `FIREBASE_*`, `HETZNER_S3_*`, `APP_BASE_URL`, `GRAPHITI_SERVICE_URL`, `GROQ_API_KEY`, `WHISPER_OPENAI_API_KEY`, `OPENAI_API_KEY`, `PROXY_URL` | This repo's `.env` |
